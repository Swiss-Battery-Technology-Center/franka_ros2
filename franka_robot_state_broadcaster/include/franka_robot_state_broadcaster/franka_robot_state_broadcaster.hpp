  ...
  private:
    ...
    : public realtime_tools::RealtimePublisher<franka_msgs::msg::FrankaRobotState>
    {
      ...
      public:
        ...
        : realtime_tools::RealtimePublisher<franka_msgs::msg::FrankaRobotState>(std::move(publisher))
        {
        }
        // NOLINTEND
      ...
      private:
        const int try_count_ = 200;  // OZHAN Changed from 10
    };
    // shared_ptr to object of override class
    std::shared_ptr<FrankaRobotStateBroadcaster::FrankaRobotStateRealtimePublisher> realtime_franka_state_publisher;
    ...
    std::shared_ptr<rclcpp::Publisher<geometry_msgs::msg::PoseStamped>> current_pose_stamped_publisher_;
    std::shared_ptr<rclcpp::Publisher<geometry_msgs::msg::PoseStamped>> last_desired_pose_stamped_publisher_;
    std::shared_ptr<rclcpp::Publisher<geometry_msgs::msg::TwistStamped>> desired_end_effector_twist_stamped_publisher_;
    std::shared_ptr<rclcpp::Publisher<geometry_msgs::msg::WrenchStamped>> external_wrench_in_base_frame_publisher_;
    std::shared_ptr<rclcpp::Publisher<geometry_msgs::msg::WrenchStamped>> external_wrench_in_stiffness_frame_publisher_;
    std::shared_ptr<rclcpp::Publisher<sensor_msgs::msg::JointState>> external_joint_torques_publisher_;
